...
public class CarPriceEstimator {
    ...
    public double getSalePrice(String makeAndModel, int yearManufactured, double milesDriven,
        ...
        if(ageOfCar <= 10){
            salePrice = salePrice - ((salePrice * 0.05d) * ageOfCar);
        }else {
            salePrice *= 0.1d;
        }
        ...
        if(additionalMiles>1000d && additionalMiles<=10_000d){
            salePrice -= 500d;
        }else if(additionalMiles>10_000d && additionalMiles<=30_000d){
            salePrice -= 1000d;
        }else if (additionalMiles>30_000d){
            salePrice -= 1500d;
        }
